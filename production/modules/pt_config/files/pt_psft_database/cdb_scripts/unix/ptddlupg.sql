...
CREATE TABLESPACE PSIMAGE2 DATAFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psimage2.dbf' SIZE 400M
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
SEGMENT SPACE MANAGEMENT AUTO;

REMARK ALTER DATABASE DATAFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psimage2.dbf'
REMARK AUTOEXTEND ON NEXT 5M MAXSIZE UNLIMITED
REMARK ;

CREATE TABLESPACE PSMATVW DATAFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psmatvw.dbf' SIZE 250M
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
SEGMENT SPACE MANAGEMENT AUTO;

REMARK ALTER DATABASE DATAFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psmatvw.dbf'
REMARK AUTOEXTEND ON NEXT 5M MAXSIZE UNLIMITED
REMARK ;

CREATE TEMPORARY TABLESPACE PSGTT01 TEMPFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psgtt01.dbf' SIZE 500M
...
REMARK 
REMARK ALTER DATABASE TEMPFILE '/<mount>/oradata/<SID>/<PDB_SERVICE_NAME>/psgtt01.dbf'
REMARK AUTOEXTEND ON NEXT 5M MAXSIZE UNLIMITED
REMARK ;
