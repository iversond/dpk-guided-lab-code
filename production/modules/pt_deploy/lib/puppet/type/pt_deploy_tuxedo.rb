...
module Puppet
  Type.newtype(:pt_deploy_tuxedo) do
    include EasyType
    include ::PtDeployUtils::Validations

    @doc = "This type manages the deployment of a Tuxedo component.
      For deploying Tuxedo, an archive file containing the pre-installed
