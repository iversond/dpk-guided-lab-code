 ...
 * ***************************************************************
 */
class pt_role::pt_tools_demo inherits pt_role::pt_base {

  notify { "Applying pt_role::pt_tools_demo": }
  ...
  if $env_type != 'fulltier' {
    fail('The pt_tools_demo role can only be applied to env_type of fulltier')
  }
